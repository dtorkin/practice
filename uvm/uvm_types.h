...
typedef enum {
    PREP_STATE_NOT_STARTED,
    PREP_STATE_READY_TO_SEND_INIT_CHANNEL, // Может быть совмещено с NOT_STARTED
    PREP_STATE_AWAITING_CONFIRM_INIT_REPLY,

    PREP_STATE_READY_TO_SEND_PROVESTI_KONTROL,
    PREP_STATE_AWAITING_PODTV_KONTROL_REPLY,
	...
	PREP_STATE_SHOOTING_PARAMS_SENT, // <--- НОВОЕ СОСТОЯНИЕ
    PREP_STATE_FAILED
} PreparationState;
